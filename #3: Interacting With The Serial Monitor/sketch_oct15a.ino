...
void setup() {
Serial.begin(9600); // Starting the Serial Mointor at the baud rate of 9600
/*  
...
for (int a = 1; a<=5; a++){
Serial.print("First LED is blinking # "); // Prints the text inside of the speech marks
Serial.println(a);  // Prints the text in a new line
...
for (int b = 1; b<=5; b++){
Serial.print("Second LED is blinking # "); 
Serial.println(b);  
